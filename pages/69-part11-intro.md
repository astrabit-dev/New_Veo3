...
| 챕터 | 제목 | 핵심 내용 |
|------|------|-----------|
| 59 | JSON 프롬프트란 무엇인가 | 개념, 장점, 활용 시기 |
| 60 | JSON 구조 상세 해설 | 각 필드(키)의 의미와 사용법 |
| 61 | 인물 없는 제품 광고 JSON 템플릿 | 완전한 템플릿 코드블록 |
| 62 | 실전 예시 1 — Blaze Energy 드링크 | 에너지 드링크 광고 완성 예시 |
| 63 | 실전 예시 2 — Noir Bloom 향수 | 향수 광고 완성 예시 |
| 64 | 나만의 JSON 템플릿 만들기 | ChatGPT/Claude 활용, 커스터마이징 |
